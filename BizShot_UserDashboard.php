...
<head>
    ...
    <link rel="stylesheet" href="css/userdashboard_styles.css" type="text/css">
    ...
    <header>
        <div class="header1">
            <div class="wrapper">
                ...
                <img class="userprofile_pic" src="images/man-in-suit2.jpg" alt="userPicture"> 
        ...
        <div class="header2">
            <div class="wrapper">
                <div id="header_menu">
                <ul class="nav">
                    <li><a href="BizShot_Article.html" class="articles">Article</a></li>
...
<div class="content_area">
    ...
    <div class="options">
        <div class="option1">
            <img src="images/option1.jpg" alt="option1">
            <h3>INVESTORS</h3>
        </div>
        <div class="option2">
            <img src="images/option2.jpg" alt="option2">
            <h3>TALENTS / IDEAS</h3>
        </div>
        <div class="option3">
            <img src="images/option3.jpg" alt="option3">
            <h3>BUSINESS EXPANSION</h3>
        </div>
    </div>
    <div class="search_area">
        <input type="text" class="search" placeholder="Enter your search term..." />
        <span class="bar"></span> 
    ...
    <div class="user-content">
        <div class="post1">
            <div class="user_details">
                ...
                <button class="follow"><i class="fa fa-user-plus" aria-hidden="true"></i>
                </button>
            </div>
            <div class="message">
        ...
        <div class="post1">
                <div class="user_details">
                    ...
                    <p class="date">12 Nov 2017</p>
                    <p class="location">Chennai</p>
                    <button class="comment" onClick="view_prev_comments()"><i class="fa fa-comment" aria-hidden="true"></i>
                    </button>
                    <button class="follow"><i class="fa fa-user-plus" aria-hidden="true"></i>
                    </button>
                </div>
